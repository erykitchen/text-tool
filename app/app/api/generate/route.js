...
12. 【以上、全項目出力完了】`
    ...
    // 1. 【最強補正】すべての全角スペースと半角スペースを、一文字残らず抹消する
    // 文章の途中だろうが行末だろうが、スペースというスペースを全て消します
    resultText = resultText.replace(/[ 　]/g, "");

    // 2. 相手の呼び名間違い（○○くん等）を正規化
    resultText = resultText.replace(/○○くん|○○さん|あなた|君/g, "%send_nickname%");

    // 3. 【完走保証】青1と完了報告の物理補完（この死守ロジックは変えません）
